...
// #define WIFI_SSID "La rosa de guadalupe" // your network SSID (name)
// #define WIFI_PASS "mexico1935"           // your network key
...
// 	} else {
//         Serial.println("* MDNS responder couldn't be started");
//     }
...
// 	Serial.println("* Arduino RemoteDebug Library 2");
// 	Serial.println("*");
...
// 		debugA("* Time: %u seconds (VERBOSE)", mTimeSeconds);

// 		if (mTimeSeconds % 5 == 0) { // Each 5 seconds

// 			// Debug levels

// 			debugA("* This is a message of debug level ALWAYS");
...
//   debugA("this is a debug - var %u", var);
//   debugA("This is a println");
// }
